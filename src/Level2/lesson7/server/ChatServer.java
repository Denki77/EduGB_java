...
import Level2.lesson7.auth.BasicAuthenticationService;
...
public class ChatServer implements Server {
    ...
    public synchronized void broadcastMessage(String message) {
        /**
         * здесь реализуем - если сообщение по сплиту содержит /w, то дальше ник и отправляем не всем, а конкректному
         */
